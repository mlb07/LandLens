...
function getParcelFactRows(facts?: ParcelFacts): ParcelFactRow[] {
  ...
  const candidates: Array<ParcelFactRow | undefined> = [
    ...
    facts.landStatus ? { key: 'landStatus', label: 'Land / tax status', value: facts.landStatus, group: 'Record' } : undefined,
    facts.planningAreaDescription ? { key: 'planningAreaDescription', label: 'Planning-area context', value: facts.planningAreaDescription, group: 'Record' } : undefined,
    facts.zoning ? { key: 'zoning', label: 'Zoning', value: facts.zoning, group: 'Record' } : undefined,
    facts.zoningConditions ? { key: 'zoningConditions', label: 'Zoning conditions', value: facts.zoningConditions, group: 'Record' } : undefined,
    ...
    facts.deedReference ? { key: 'deedReference', label: 'Deed reference', value: facts.deedReference, group: 'Record' } : undefined,
    facts.platReference ? { key: 'platReference', label: 'Plat reference', value: facts.platReference, group: 'Record' } : undefined,
    facts.recordedDate ? { key: 'recordedDate', label: 'Recorded date', value: facts.recordedDate, group: 'Record' } : undefined,
    ...
    amount(facts.marketLandValue) ? { key: 'marketLandValue', label: 'Market land value', value: amount(facts.marketLandValue)!, group: 'Valuation' } : undefined,
    amount(facts.marketImprovementValue) ? { key: 'marketImprovementValue', label: 'Market improvement value', value: amount(facts.marketImprovementValue)!, group: 'Valuation' } : undefined,
    ...
    amount(facts.appraisedLandValue) ? { key: 'appraisedLandValue', label: 'Appraised land value', value: amount(facts.appraisedLandValue)!, group: 'Valuation' } : undefined,
    amount(facts.appraisedImprovementValue) ? { key: 'appraisedImprovementValue', label: 'Appraised improvement value', value: amount(facts.appraisedImprovementValue)!, group: 'Valuation' } : undefined,
    ...
    amount(facts.assessedOtherValue) ? { key: 'assessedOtherValue', label: 'Other assessed value', value: amount(facts.assessedOtherValue)!, group: 'Valuation' } : undefined,
    amount(facts.taxableValue) ? { key: 'taxableValue', label: 'Taxable value', value: amount(facts.taxableValue)!, group: 'Valuation' } : undefined,
    amount(facts.taxAmount) ? { key: 'taxAmount', label: 'Reported property tax', value: amount(facts.taxAmount)!, group: 'Valuation' } : undefined,
    sale(facts) ? { key: 'lastSale', label: 'Last recorded sale', value: sale(facts)!, group: 'Valuation' } : undefined,
    facts.saleQualification ? { key: 'saleQualification', label: 'Sale qualification', value: facts.saleQualification, group: 'Valuation' } : undefined,
    number(facts.yearBuilt) ? { key: 'yearBuilt', label: 'Year built', value: number(facts.yearBuilt)!, group: 'Improvements' } : undefined,
    number(facts.effectiveYearBuilt) ? { key: 'effectiveYearBuilt', label: 'Effective year built', value: number(facts.effectiveYearBuilt)!, group: 'Improvements' } : undefined,
    ...
    facts.buildingQuality ? { key: 'buildingQuality', label: 'Building quality', value: facts.buildingQuality, group: 'Improvements' } : undefined,
    ...
    number(facts.lotAreaSqFt, ' sq ft') ? { key: 'lotAreaSqFt', label: 'Recorded lot area', value: number(facts.lotAreaSqFt, ' sq ft')!, group: 'Land profile' } : undefined,
    number(facts.garageAreaSqFt, ' sq ft') ? { key: 'garageAreaSqFt', label: 'Garage area', value: number(facts.garageAreaSqFt, ' sq ft')!, group: 'Improvements' } : undefined,
    number(facts.carportAreaSqFt, ' sq ft') ? { key: 'carportAreaSqFt', label: 'Carport area', value: number(facts.carportAreaSqFt, ' sq ft')!, group: 'Improvements' } : undefined,
    number(facts.stories) ? { key: 'stories', label: 'Stories', value: number(facts.stories)!, group: 'Improvements' } : undefined,
    number(facts.unitCount) ? { key: 'unitCount', label: 'Building units', value: number(facts.unitCount)!, group: 'Improvements' } : undefined,
    number(facts.roomCount) ? { key: 'roomCount', label: 'Total rooms', value: number(facts.roomCount)!, group: 'Improvements' } : undefined,
    number(facts.bedroomCount) ? { key: 'bedroomCount', label: 'Bedrooms', value: number(facts.bedroomCount)!, group: 'Improvements' } : undefined,
    number(facts.bathroomCount) ? { key: 'bathroomCount', label: 'Bathrooms', value: number(facts.bathroomCount)!, group: 'Improvements' } : undefined,
    number(facts.halfBathroomCount) ? { key: 'halfBathroomCount', label: 'Half bathrooms', value: number(facts.halfBathroomCount)!, group: 'Improvements' } : undefined,
    number(facts.fireplaceCount) ? { key: 'fireplaceCount', label: 'Fireplaces', value: number(facts.fireplaceCount)!, group: 'Improvements' } : undefined,
    facts.poolDescription ? { key: 'poolDescription', label: 'Pool indicator', value: facts.poolDescription, group: 'Improvements' } : undefined,
    ...
    facts.irrigationDescription ? { key: 'irrigationDescription', label: 'Irrigation', value: facts.irrigationDescription, group: 'Land profile' } : undefined,
    facts.waterfrontDescription ? { key: 'waterfrontDescription', label: 'Waterfront indicator', value: facts.waterfrontDescription, group: 'Land profile' } : undefined,
    facts.permitDescription ? { key: 'permitDescription', label: 'Building permit descriptor', value: facts.permitDescription, group: 'Improvements' } : undefined,
    facts.criticalAreaDescription ? { key: 'criticalAreaDescription', label: 'Critical-area designation', value: facts.criticalAreaDescription, group: 'Land profile' } : undefined,
    number(facts.percTestArea) ? { key: 'percTestArea', label: 'Recorded perc-test area', value: number(facts.percTestArea)!, group: 'Land profile' } : undefined,
    ...
    number(facts.agriculturalPreservationAcres, ' ac') ? { key: 'agriculturalPreservationAcres', label: 'Agricultural preservation area', value: number(facts.agriculturalPreservationAcres, ' ac')!, group: 'Land profile' } : undefined,
    ...
    number(facts.forestPercent, '%') ? { key: 'forestPercent', label: 'Forest cover', value: number(facts.forestPercent, '%')!, group: 'Land profile' } : undefined,
  ]

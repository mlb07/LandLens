...
- **Normalized parcel facts:** Florida, Connecticut, Montana, New York, and Travis/Dallas/Harris/Bexar/Collin/Williamson/Montgomery/Tarrant County sources now normalize every verified development-relevant field they publish: property classification/zoning, public values, sales, improvements, frontage/depth, utilities, legal/subdivision fields, and agricultural land allocations where available. Facts persist with saved sites and print in reports. Owner and mailing fields are deliberately excluded.
- **Local entitlement/utility evidence:** the Austin/Travis pack combines City zoning, planning jurisdiction, selected high-impact overlays, neighborhood-plan future land use, principal RR/SF-1/SF-2/SF-3 standards, an optional §25-2-491 concrete-use screen, and Austin Energy electric-service-area screening. It applies code results only in mapped full- or limited-purpose jurisdiction. Special districts, superseding overlays, plats, deed restrictions, and utility capacity remain controlling.

...
- Exact parcel outlining and source-backed name/acreage autofill across 30 states through 37 verified public adapters
...
Verified statewide or statewide-mosaic parcel sources are currently connected for **AK, AR, AZ, CO, CT, DE, FL, HI, ID, IN, MA, ME, MN, MT, NC, ND, NE, NH, NJ, NY, NV, OH, OR, TN, UT, VA, VT, WA, WV, and WI**, plus local official coverage from **Travis, Dallas, Harris, Bexar, Collin, Williamson, Montgomery, and Tarrant** sources in Texas, and **Maricopa County** in Arizona. Local participation and update dates vary, so even a supported state can contain gaps. LandLens metrics still screen a selected **point**, even when an approximate assessor parcel boundary is available. Parcel outlines are not surveys, and public-source results do not establish buildable acreage, legal access, jurisdictional wetlands, survey-grade topography, zoning, utility capacity, or market feasibility. Unsupported and offline coverage is labeled explicitly; LandLens never invents a boundary.
